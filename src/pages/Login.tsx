					...
					<div className="mt-5 sm:mt-10">
						...
						<div>
							<div className="relative flex flex-col mx-1 mb-6 sm:mx-6">
								<span className="mb-2 text-sm font-semibold">Password</span>
								<input
									minLength={8}
									onChange={(event) => handleChange(event.target)}
									ref={passwordInput}
						...
						<div className="flex items-center justify-between mx-6 mt-8">
							<button
								type="submit"
								className="p-2 px-4 bg-[#0277FA] rounded-md hover:bg-[#0276fad8] active:bg-[#0276fac9]"
							>
								Login
							</button>
							<Link
						...
						<div className="mt-6 text-center sm:mx-6">
							...
							<Link
								to="/register"
								className="text-sm text-[#0277FA] cursor-pointer"
							>
								{" "}
								Sign up.
							</Link>
